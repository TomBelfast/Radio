...
import { generateWeather, synthesizeAudio } from '@/lib/api';
...
export const WeatherForm = () => {
    ...
    const handleGenerate = async () => {
        ...
        setAudioBlob(null);
        try {
            const data = await generateWeather(city, "current", style);
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Generate a weather update for a specific city.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <Input id="style" placeholder="e.g. Relaxed, Fast" value={style} onChange={(e) => setStyle(e.target.value)} />
                </div>
                {resultText && (
